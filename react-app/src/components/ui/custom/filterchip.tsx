...
export { Button, filterChipVariants }
...
export default function FilterChip({ color, badge, h3, p, imagePreviewSrc, imageFullSrc=[], imageShadow }: FilterChipProps) {


  return (
    <div className="p-[11px] bg-bg-secondary rounded">
