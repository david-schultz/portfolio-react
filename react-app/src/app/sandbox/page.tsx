...
export default function Sandbox() {
  ...
  return (
    <main className="min-h-screen flex flex-col gap-4 mb-32">
       ...
       <section className="mx-2 bg-neutral-800 rounded-b-lg mb-64 h-[600px] md:h-[800px]">
        <div className="w-full h-[600px] md:h-[800px] top-0">
          <GlassScene />
        </div>

        <div className="absolute top-0 z-1 w-full p-6">
